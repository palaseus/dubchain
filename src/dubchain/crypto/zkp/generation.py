...
from .core import ZKPType, ZKPStatus, ZKPError
...
class ProofGenerator(ABC):
    ...
    @abstractmethod
    def generate_proof(self, witness: Witness, public_inputs: PublicInputs) -> Tuple[bytes, Dict[str, Any]]:
...
def create_proof_generator(circuit: ZKCircuit, zkp_type: ZKPType, 
                          setup: Optional[TrustedSetup] = None) -> ProofGenerator:
