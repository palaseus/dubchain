...
class CUDAConsensusAccelerator:
    ...
    def process_consensus_operations(
    ...
    def benchmark_consensus_operations(
...
def set_global_cuda_consensus_accelerator(
    accelerator: CUDAConsensusAccelerator,
) -> None:
